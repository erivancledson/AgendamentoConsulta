...
public class ConsultaController {
	 ...
	 public String detalhesConsultaCadastraPaciente(@PathVariable("codigo") long codigo,@Valid Paciente paciente, BindingResult result, RedirectAttributes attributes) {
